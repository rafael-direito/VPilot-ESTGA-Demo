...
# @Last Modified time: 2022-10-18 10:34:22
...
class AttachmentRef(BaseModel):
    ...
    href: Optional[str] = Field(
        None, description='URL serving as reference for the attachment resource'
    )
    description: Optional[str] = Field(
        None, description='A narrative text describing the content of the attachment'
    )
    name: Optional[str] = Field(None, description='Name of the related entity.')
    url: Optional[str] = Field(None, description='Link to the attachment media/content')
...
class Characteristic(BaseModel):
    ...
    value: AnyModel = Field(..., description='The value of the characteristic')
    _baseType: Optional[str] = Field(
        None,
        alias='@baseType',
        description='When sub-classing, this defines the super-class',
...
class EntityRef(BaseModel):
    ...
    href: Optional[str] = Field(None, description='Reference of the related entity.')
    name: Optional[str] = Field(None, description='Name of the related entity.')
    _baseType: Optional[str] = Field(
        None,
        alias='@baseType',
...
class MediumCharacteristic(BaseModel):
    ...
    faxNumber: Optional[str] = Field(None, description='The fax number of the contact')
    ...
    stateOrProvince: Optional[str] = Field(None, description='State or province')
    street1: Optional[str] = Field(None, description='Describes the street')
    street2: Optional[str] = Field(None, description='Complementary street description')
    _baseType: Optional[str] = Field(
        None,
        alias='@baseType',
        description='When sub-classing, this defines the super-class',
...
class Quantity(BaseModel):
    amount: Optional[float] = Field(1, description='Numeric value in a given unit')
...
class RelatedParty(BaseModel):
    ...
    href: Optional[str] = Field(None, description='Reference of the related entity.')
    name: Optional[str] = Field(None, description='Name of the related entity.')
    role: Optional[str] = Field(None, description='Role played by the related party')
    _baseType: Optional[str] = Field(
        None,
        alias='@baseType',
        description='When sub-classing, this defines the super-class',
...
class TaxDefinition(BaseModel):
    id: Optional[str] = Field(None, description='Unique identifier of the tax.')
...
class Attachment(BaseModel):
    ...
    size: Optional[Quantity] = Field(None, description='The size of the attachment.')
    validFor: Optional[TimePeriod] = Field(
        None, description='The period of time for which the attachment is valid'
    )
    _baseType: Optional[str] = Field(
        None,
        alias='@baseType',
...
class ContactMedium(BaseModel):
    ...
    preferred: Optional[bool] = Field(
        None, description='If true, indicates that is the preferred contact medium'
    )
    characteristic: Optional[MediumCharacteristic] = Field(
        None, description='Any additional characteristic(s) of this contact medium'
    )
    validFor: Optional[TimePeriod] = Field(
        None, description='The time period that the contact medium is valid for'
    )
    _baseType: Optional[str] = Field(
        None,
        alias='@baseType',
...
class Disability(BaseModel):
    disabilityCode: Optional[str] = Field(None, description='Code of the disability')
    disabilityName: Optional[str] = Field(None, description='Name of the disability')
...
class LanguageAbility(BaseModel):
    ...
    languageCode: Optional[str] = Field(None, description='Language code (RFC 5646)')
...
class OtherNameIndividual(BaseModel):
    ...
    familyNamePrefix: Optional[str] = Field(None, description='Family name prefix')
    ...
    middleName: Optional[str] = Field(None, description='Middle name or initial')
    ...
    title: Optional[str] = Field(
        None, description='Use for titles (aristrocatic, social, ...): Pr, Dr, Sir,....'
    )
    validFor: Optional[TimePeriod] = None
    _baseType: Optional[str] = Field(
        None,
...
class Skill(BaseModel):
    ...
    evaluatedLevel: Optional[str] = Field(
        None, description='Level of expertise in a skill evaluated for an individual'
    )
...
class TaxExemptionCertificate(BaseModel):
    id: Optional[str] = Field(
        None, description='Unique identifier of the certificate of the tax exemption'
    )
    attachment: Optional[AttachmentRefOrValue] = None
...
class Individual(BaseModel):
    ...
    givenName: Optional[str] = Field(None, description='First name of the individual')
    legalName: Optional[str] = Field(
        None,
        description='Legal name or birth name (name one has for official purposes)',
    )
    ...
    middleName: Optional[str] = Field(None, description='Middles name or initial')
    nationality: Optional[str] = Field(None, description='Nationality')
    placeOfBirth: Optional[str] = Field(
        None, description='Reference to the place where the individual was born'
    )
    preferredGivenName: Optional[str] = Field(
        None,
...
class Organization(BaseModel):
    ...
    isHeadOffice: Optional[bool] = Field(
        None, description='If value is true, the organization is the head office'
    )
    ...
    externalReference: Optional[List[ExternalReference]] = None
    organizationChildRelationship: Optional[List[OrganizationChildRelationship]] = None
    organizationIdentification: Optional[List[OrganizationIdentification]] = None
...
class Party(BaseModel):
    id: Optional[str] = Field(None, description='Unique identifier of the organization')
    href: Optional[str] = Field(
        None, description='Hyperlink to access the organization'
    )
    contactMedium: Optional[List[ContactMedium]] = None
...
class OrganizationCreateEvent(BaseModel):
    ...
    description: Optional[str] = Field(None, description='An explnatory of the event.')
    ...
    eventType: Optional[str] = Field(None, description='The type of the notification.')
    ...
    href: Optional[str] = Field(None, description='Reference of the ProcessFlow')
    id: Optional[str] = Field(None, description='Identifier of the Process flow')
    ...
    event: Optional[OrganizationCreateEventPayload] = Field(
        None, description='The event payload linked to the involved resource object'
    )
